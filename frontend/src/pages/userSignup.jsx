...
const UserSignup = () => {
  ...
  return (
    ...
    <div className="relative p-8 rounded-md shadow-lg bg-slate-800 border-slate-400 backdrop-filter backdrop-blur-sm bg-opacity-30">
        <h1 className="mb-6 text-4xl text-whitefont-bold tect-center">Register</h1>
        <form action="">

        <div className="relative my-4">
            <input type="firstName" name="firstName" className='block w-72 py-2.3 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:text-white focus:border-blue-600 peer' placeholder='' onChange={saveUserData}/>
        ...
        <div className="relative my-4">
            <input type="password" name="password" className='block w-72 py-2.3 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:text-white focus:border-blue-600 peer' onChange={saveUserData}/>
