        ...
        >
          <div className="flex flex-col">
            ...
            <input
              ...
              id="userName"
              onChange={handletext}
              className="px-8 py-2 rounded-xl border-[#94a3b8] border-2"
            />
          </div>
          <div className="flex flex-col gap-1">
            <div className="flex justify-between">
              <span>Password</span>
              <a href="./#">
                <span className="text-[#164e63] hover:text-[#0e7490]">
                  Forget password?
                </span>
              </a>
            </div>
            <div>
              <input
                ...
                id="Pswd"
                onChange={handletext}
                className="w-full px-8 py-2 rounded-xl border-[#94a3b8] border-2"
              />
            </div>
          </div>
          <div className="flex justify-center">
            <button
              ...
              onClick={handleclick}
              name="logIn"
              className="py-2 px-8 rounded-xl bg-[#0e7490] w-full hover:bg-[#0891b2]"
            >
        ...
        <Link to="/CreateAccount">
          <div className="flex justify-center">
            <button
              type="button"
              value=""
              className="px-8 py-2 rounded-xl bg-[#0e7490] w-full hover:bg-[#0891b2]"
            >
