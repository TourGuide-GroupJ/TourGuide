...
const Navbar = () => {
  return (
    <nav className="flex justify-between hotels-center bg-black opacity-80 fixed top-0 left-0 right-0 w-full p-4 py-8 z-40">
      <div className="flex hotels-center gap-1">
      ...
      <div className="md:justify-end justify-start md:static absolute md:min-h-fit bg-black opacity-90 min-h-[30vh] left-0 top-[80px] w-full flex hotels-center px-5 z-20">
        <ul className="flex md:flex-row flex-col md:hotels-center gap-4">
          <li>
            <Link
